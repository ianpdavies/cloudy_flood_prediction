import __init__
from models import get_nn_bn2_f1 as model_func
...
def load_macro_soft_f1_model(checkpoint):
    get_custom_objects().update({"macro_double_soft_f1": macro_double_soft_f1})
