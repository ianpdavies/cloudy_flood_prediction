...
import os
from training import training5
...
# ==================================================================================
# Half of images at 40%, no MCD, no val data. Permanent water pixels are completely removed.
# Batch size = 8192
# ==================================================================================
# Parameters
...
# training5(img_list, pctls, model_func, feat_list_new, uncertainty,
#           data_path, batch, **model_params)
