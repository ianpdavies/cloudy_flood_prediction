...
# Actually to figure out a way to remove perm water only in training and when calculating prediction metrics
...
prediction(img_list, pctls, feat_list_new, data_path, batch, remove_perm=False)
