# Logistic regression generalized model trained on multiple images
...
def log_reg_gen_prediction(img_list_test, pctls, feat_list_new, data_path, batch):
    for j, img in enumerate(img_list_test):
        times = []
