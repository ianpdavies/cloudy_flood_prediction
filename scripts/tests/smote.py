# Test using SMOTE to increase size of minority (flooded) class in imbalanced dataset
...
def log_reg_training_smote(img_list, pctls, feat_list_new, feat_list_all, data_path, batch):
...
# ======================================================================================================================
img_list = [img_list[0]]
log_reg_training_smote(img_list, pctls, feat_list_new, feat_list_all, data_path, batch)
