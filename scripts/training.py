    ...
    for j, img in enumerate(img_list):
        ...
        for i, pctl in enumerate(pctls):
            ...
            if uncertainty:
                ...
                metrics_path = data_path / batch / 'metrics' / 'training_nn_mcd' / img / '{}'.format(img + '_clouds_' + str(pctl))
            else:
                model_path = data_path / batch / 'models' / 'nn' / img
                metrics_path = data_path / batch / 'metrics' / 'training_nn' / img / '{}'.format(img + '_clouds_' + str(pctl))
